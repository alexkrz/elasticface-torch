# This code is from https://github.com/fdbtrs/ElasticFace/blob/main/utils/losses.py
...
class ElasticArcFace(nn.Module):
    ...
    def forward(self, embbedings, label):
        ...
        margin = torch.normal(
            mean=self.m, std=self.std, size=label[index, None].size(), device=cos_theta.device
